...
#define P_LOOKAHEAD_MIN 5.0            // m
#define P_LOOKAHEAD_MAX 10.0           // m
...
#define P_REACTION_TIME 0.125           // secs
#define P_NUM_POINTS_IN_SPIRAL 9       // Num of points in the spiral
